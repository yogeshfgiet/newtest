$(function () {
    ...
    $(".form-wizard").steps({
        ...
        messages: {
            ...
            bank_name: "The bank name field is required and cannot be empty",
            account_name: "The account name field is required and cannot be" +
            " empty",
            routing_number: "The routing number field is required and cannot" +
            " be empty",
            account_number: "The account number field is required and cannot" +
            " be empty",
            account_type: "The account type field is required and cannot be" +
            " empty",
            card_full_name: "The card full name field is required and cannot" +
            " be empty",
            card_number: "The card number field is required and cannot be empty",
            expiry_month: "The expiry month field is required and cannot be" +
            " empty",
            expiry_year: "The expiry year field is required and cannot be" +
            " empty",
            cvv_number: "The cvv number field is required and cannot be empty",
        },
        errorPlacement: function(error, element) {
