...
use AuthenticatesAndRegistersUsers,
    ...
    public function postRegister(Request $request)
    {
       ...
       //$phone_number =  $getParams['first_phone_number'].$getParams['second_phone_number'] . $getParams['third_phone_number'];
        ...
        Mail::send('emails.register', $userData, function($message) use ($getParams)
        {
            $message->to($getParams['email'])
